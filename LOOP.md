...
State (2026-07-13, latest — Epic F slice F2 epoch-boundary crossing SHIPPED, harness `--full` green locally, PR + red-team pending): **STATUS: DONE holds; Epic F is F1✅ F2✅, F3..F6 open.**
