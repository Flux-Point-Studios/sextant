...
State (2026-07-13, latest — Epic F slice F4 two-region honesty + re_anchor BUILT, harness `--full` green locally, PARKED for the operator's independent red-team per the merge policy): **STATUS: DONE holds; Epic F is F1✅ F2✅ F3✅ F4✅, F4b/F5/F6 open.**
