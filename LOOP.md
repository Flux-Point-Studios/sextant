...
State (2026-07-13, latest — Epic F slice F3 rollback truncation + eviction-as-finalization SHIPPED, harness `--full` green locally, PR + red-team pending): **STATUS: DONE holds; Epic F is F1✅ F2✅ F3✅, F4..F6 open.**
